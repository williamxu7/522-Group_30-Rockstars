...
"""Analysis of Housing Prices using Ridge Regression

Usage: data_analysis.py --in_file1=<in_file1> --in_file2=<in_file2>
                        --out_file1=<out_file1> --out_file2=<out_file2> 
...
<out_file2>      file path of the test score
...
def main(in_file1,in_file2, out_file1, out_file2):
...
if __name__ == "__main__":
    main(opt["--in_file1"], opt["--in_file2"], opt["--out_file1"], opt["--out_file2"])
