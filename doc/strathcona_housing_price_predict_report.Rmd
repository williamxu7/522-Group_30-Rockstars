...
```{r barchart-plot, echo=FALSE, fig.cap="Figure 1.", out.height="100%"}
...
```{r correlation-heat-map, echo=FALSE, fig.cap="Figure 1.", out.height="100%"}
knitr::include_graphics("../results/corrmat.png")
```


```{r scatter-plot, echo=FALSE, fig.cap="Figure 1.", out.height="100%"}
knitr::include_graphics("../results/scatter.png")
```


```{r boxplot, echo=FALSE, fig.cap="Figure 1.", out.height="100%"}
